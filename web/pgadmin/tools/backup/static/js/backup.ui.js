...
export class ExcludeTablesSchema extends BaseUISchema {
  constructor(fieldOptions={}, initValues={}) {
    super({
      ...initValues,
    });
...
export function getExcludeTablesSchema() {
  return new ExcludeTablesSchema();
}

export default class BackupSchema extends BaseUISchema {
  constructor(sectionSchema, typeObjSchema, saveOptSchema, disabledOptionSchema, miscellaneousSchema, excludeTablesSchema, fieldOptions = {}, treeNodeInfo=[], pgBrowser=null, backupType='server', objects={}) {
    super({
      file: undefined,
      format: 'custom',
      id: null,
    ...
    this.getExcludeTablesSchema = excludeTablesSchema;
  }
  ...
  get baseFields() {
    ...
    return [{
      ...
      group: gettext('Table Options'),
      schema: obj.getExcludeTablesSchema(),
      visible: isVisibleForServerBackup(obj.backupType),
      helpMessage: gettext('This option is enabled only when Use INSERT Commands is enabled.')
    }, {
      type: 'nested-fieldset',
